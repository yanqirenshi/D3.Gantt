...
export default class Builder {
     ...
     * WBS を階層構造に組み上げる。
     * */
    build (data_wbs, data_workpackages, style) {
        // data で Wbs, Workpackage クラスインスタンスを生成する。
        const wbs_ht = this.makeWbsNode(data_wbs, d=> new c.Wbs(d, style.body.row));
        const wp_ht  = this.makeWbsNode(data_workpackages, d=> new c.Workpackage(d, style.body.chart));
